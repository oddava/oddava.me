...
const mdxComponents = {
  CardComparison: block({
    ...
    schema: {
      ...
      fit: fields.text({
        label: 'Fit Mode (cover/contain/fill/none/scale-down)',
      }),
      ...
      beforeAlign: fields.text({
        label: 'Before Alignment (top/center/bottom)',
      }),
      afterAlign: fields.text({ label: 'After Alignment (top/center/bottom)' }),
      beforePosition: fields.text({
        label: 'Before Object Position (CSS value)',
      }),
      afterPosition: fields.text({
        label: 'After Object Position (CSS value)',
      }),
